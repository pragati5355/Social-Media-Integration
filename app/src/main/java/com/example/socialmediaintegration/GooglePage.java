...
public class GooglePage extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        progressDialog = new ProgressDialog(GooglePage.this);
        ...
        if (settings_save.getString("gmail_saved", "").toString().equals("gmail_saved"))
        {
            ...
            Picasso.get().load(sharedPreferences.getString(EmailprofileUrl, "")).placeholder(R.drawable.fbdp).into(circleImageView);
        ...
        if(account != null)
        {
            ...
            Picasso.get().load(Pemail_profileUrl).placeholder(R.drawable.fbdp).into(circleImageView);
        ...
        logout.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(GooglePage.this);
                                ...
                                Auth.GoogleSignInApi.signOut(googleApiClient).setResultCallback(new ResultCallback<Status>()
                                {
                                    ...
                                    public void onResult(@NonNull Status status)
                                    {
                                        ...
                                        if(status.isSuccess())
                                        {
                                            ...
                                            Toast.makeText(GooglePage.this, "Gmail Logged out successfully!", Toast.LENGTH_SHORT).show();
                                        ...
                                        else
                                        {
                                            ...
                                            Toast.makeText(GooglePage.this, "Gmail Log out failed!", Toast.LENGTH_SHORT).show();
